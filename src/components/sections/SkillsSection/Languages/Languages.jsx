      ...
      <h2>Languages</h2>
        <ul className={styles.list}>
          ...
          <li className={styles.item}>
            <span className={styles.language}>Polish</span>: <span className={styles.level}>Basic (A2)</span>
          </li>
          <li className={styles.item}>
            <span className={styles.language}>English</span>: <span className={styles.level}>Basic (A2)</span>
          </li>
          <li className={styles.item}>
